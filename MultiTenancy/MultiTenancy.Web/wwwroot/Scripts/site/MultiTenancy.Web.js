...
(function (MultiTenancy) {
    ...
    (function (Admninistration) {
        var TenantsForm = /** @class */ (function (_super) {
            ...
            TenantsForm.formKey = 'Admninistration.Tenants';
            return TenantsForm;
        }(Serenity.PrefixedContext));
        Admninistration.TenantsForm = TenantsForm;
    })(Admninistration = MultiTenancy.Admninistration || (MultiTenancy.Admninistration = {}));
})(MultiTenancy || (MultiTenancy = {}));
var MultiTenancy;
(function (MultiTenancy) {
    var Admninistration;
    (function (Admninistration) {
        ...
        (function (TenantsRow) {
            ...
            TenantsRow.localTextPrefix = 'Admninistration.Tenants';
            TenantsRow.lookupKey = 'Administration.Tenant';
            function getLookup() {
                return Q.getLookup('Administration.Tenant');
            }
            TenantsRow.getLookup = getLookup;
        })(TenantsRow = Admninistration.TenantsRow || (Admninistration.TenantsRow = {}));
    })(Admninistration = MultiTenancy.Admninistration || (MultiTenancy.Admninistration = {}));
})(MultiTenancy || (MultiTenancy = {}));
var MultiTenancy;
(function (MultiTenancy) {
    ...
    (function (Admninistration) {
        ...
        (function (TenantsService) {
            TenantsService.baseUrl = 'Admninistration/Tenants';
            [
                'Create',
                'Update',
                'Delete',
        ...
        })(TenantsService = Admninistration.TenantsService || (Admninistration.TenantsService = {}));
    })(Admninistration = MultiTenancy.Admninistration || (MultiTenancy.Admninistration = {}));
})(MultiTenancy || (MultiTenancy = {}));
var MultiTenancy;
(function (MultiTenancy) {
    ...
    (function (Admninistration) {
        var TenantsDialog = /** @class */ (function (_super) {
            ...
            function TenantsDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Admninistration.TenantsForm(_this.idPrefix);
                return _this;
            }
            TenantsDialog.prototype.getFormKey = function () { return Admninistration.TenantsForm.formKey; };
            TenantsDialog.prototype.getIdProperty = function () { return Admninistration.TenantsRow.idProperty; };
            TenantsDialog.prototype.getLocalTextPrefix = function () { return Admninistration.TenantsRow.localTextPrefix; };
            TenantsDialog.prototype.getNameProperty = function () { return Admninistration.TenantsRow.nameProperty; };
            TenantsDialog.prototype.getService = function () { return Admninistration.TenantsService.baseUrl; };
            TenantsDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], TenantsDialog);
            return TenantsDialog;
        }(Serenity.EntityDialog));
        Admninistration.TenantsDialog = TenantsDialog;
    })(Admninistration = MultiTenancy.Admninistration || (MultiTenancy.Admninistration = {}));
})(MultiTenancy || (MultiTenancy = {}));
var MultiTenancy;
(function (MultiTenancy) {
    ...
    (function (Admninistration) {
        var TenantsGrid = /** @class */ (function (_super) {
            ...
            TenantsGrid.prototype.getColumnsKey = function () { return 'Admninistration.Tenants'; };
            TenantsGrid.prototype.getDialogType = function () { return Admninistration.TenantsDialog; };
            TenantsGrid.prototype.getIdProperty = function () { return Admninistration.TenantsRow.idProperty; };
            TenantsGrid.prototype.getLocalTextPrefix = function () { return Admninistration.TenantsRow.localTextPrefix; };
            TenantsGrid.prototype.getService = function () { return Admninistration.TenantsService.baseUrl; };
            TenantsGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], TenantsGrid);
            return TenantsGrid;
        }(Serenity.EntityGrid));
        Admninistration.TenantsGrid = TenantsGrid;
    })(Admninistration = MultiTenancy.Admninistration || (MultiTenancy.Admninistration = {}));
})(MultiTenancy || (MultiTenancy = {}));
var MultiTenancy;
(function (MultiTenancy) {
