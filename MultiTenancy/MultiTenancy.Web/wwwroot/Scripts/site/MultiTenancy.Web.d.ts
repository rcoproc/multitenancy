...
declare namespace MultiTenancy.Admninistration {
}
declare namespace MultiTenancy.Admninistration {
...
declare namespace MultiTenancy.Admninistration {
    ...
    namespace TenantsRow {
        ...
        const localTextPrefix = "Admninistration.Tenants";
...
declare namespace MultiTenancy.Admninistration {
    namespace TenantsService {
        const baseUrl = "Admninistration/Tenants";
...
declare namespace MultiTenancy.Common.Pages {
